...
public class OpenSQLConnection {
	...
	private String createStatsTableQuery = "CREATE TABLE `player_stats` (" + "  `id` int(9) NOT NULL AUTO_INCREMENT,"
			...
			+ "  `opposition` varchar(25) DEFAULT NULL," + "  `minP` double(8,1) DEFAULT NULL,"
			+ "  `pointsP` double(8,2) DEFAULT NULL," + "  `fgpP` double(8,2) DEFAULT NULL," + "  `fgaP` double(8,2) DEFAULT NULL,"
			+ "  `fgmP` double(8,2) DEFAULT NULL," + "  `ftpP` double(8,2) DEFAULT NULL," + "  `ftmP` double(8,2) DEFAULT NULL,"
			+ "  `ftaP` double(8,2) DEFAULT NULL," + "  `tppP` double(8,2) DEFAULT NULL," + "  `tpmP` double(8,2) DEFAULT NULL,"
			+ "  `tpaP` double(8,2) DEFAULT NULL," + "  `rebP` double(8,2) DEFAULT NULL," + "  `astP` double(8,2) DEFAULT NULL,"
			+ "  `stlP` double(8,2) DEFAULT NULL," + "  `blkP` double(8,2) DEFAULT NULL," + "  `tovP` double(8,2) DEFAULT NULL,"
			+ "  `minA` double(8,2) DEFAULT NULL," + "  `pointsA` double(8,2) DEFAULT NULL," + "  `fgpA` double(8,2) DEFAULT NULL,"
			+ "  `fgaA` double(8,2) DEFAULT NULL," + "  `fgmA` double(8,2) DEFAULT NULL," + "  `ftpA` double(8,2) DEFAULT NULL,"
			+ "  `ftmA` double(8,2) DEFAULT NULL," + "  `ftaA` double(8,2) DEFAULT NULL," + "  `tppA` double(8,2) DEFAULT NULL,"
			+ "  `tpmA` double(8,2) DEFAULT NULL," + "  `tpaA` double(8,2) DEFAULT NULL," + "  `rebA` double(8,2) DEFAULT NULL,"
			+ "  `astA` double(8,2) DEFAULT NULL," + "  `stlA` double(8,2) DEFAULT NULL," + "  `blkA` double(8,2) DEFAULT NULL,"
			+ "  `tovA` double(8,2) DEFAULT NULL," + "  `minR` double(8,2) DEFAULT NULL," + "  `pointsR` double(8,2) DEFAULT NULL,"
			+ "  `fgpR` double(8,2) DEFAULT NULL," + "  `fgaR` double(8,2) DEFAULT NULL," + "  `fgmR` double(8,2) DEFAULT NULL,"
			+ "  `ftpR` double(8,2) DEFAULT NULL," + "  `ftmR` double(8,2) DEFAULT NULL," + "  `ftaR` double(8,2) DEFAULT NULL,"
			+ "  `tppR` double(8,2) DEFAULT NULL," + "  `tpmR` double(8,2) DEFAULT NULL," + "  `tpaR` double(8,2) DEFAULT NULL,"
			+ "  `rebR` double(8,2) DEFAULT NULL," + "  `astR` double(8,2) DEFAULT NULL," + "  `stlR` double(8,2) DEFAULT NULL,"
			+ "  `blkR` double(8,2) DEFAULT NULL," + "  `tovR` double(8,2) DEFAULT NULL,"
			+ "  `projectionWins` int(5) DEFAULT NULL," + "  `averageWins` int(5) DEFAULT NULL,"
			+ "  `date` varchar(25) DEFAULT NULL," + "  PRIMARY KEY (`id`)"
	...
	public void bestPredictionsOnMinProjected() {
		...
		try {
			...
			preparedStatement = con.prepareStatement("");
			int maxMin = 46;
			int sampleSetSize = 201;
			for (int i = 0; i < maxMin && sampleSetSize>200; i++) {
				ResultSet rs = preparedStatement.executeQuery("SELECT * FROM player_stats WHERE minR > " + i);
				rs.last();
				...
				rs = preparedStatement.executeQuery("SELECT projectionWins FROM player_stats WHERE minR > " + i);
				while (rs.next()) {
					predScore += rs.getInt("projectionWins");
				}
				ResultSet rs2 = preparedStatement.executeQuery("SELECT averageWins FROM player_stats WHERE minR > " + i);
				while (rs2.next()) {
					aveScore += rs2.getInt("averageWins");
				}
				
				System.out.println("Current prediction: " + predScore/(predScore+aveScore) + ", when min = " + i);
			...
			System.out.println("Highest prediction: " + highPred + ", when min = " + highestIndex);
